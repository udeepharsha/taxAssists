...
$(document).ready(function() {
	...
	$('#submit_wht').on('submit', function(event){
		...
		var other_data = $('#submit_wht').serializeArray();
...
function editServiceItem(id, hiddenValue){
	...
	var selectDiv = '<select id="typeOfTransaction'+id+'"> <option value="Rent">Rent</option> <option value="Interest">Interest</option> <option value="Dividend">Dividend</option> <option value="Royalty">Royalty</option> <option value="Construction">Construction</option> <option value="Commissions">Commissions</option> <option value="Professional Service">Professional Service</option> <option value="Consultancy Service">Consultancy Service</option> <option value="Technical Service">Technical Service</option> <option value="Management Service">Management Service</option> <option value="Contract for supply of other services">Contract for supply of other services</option> <option value="Agency Arrangements">Agency Arrangements</option> <option value="Others- I cannot determine">Others- I cannot determine</option> </select>';
...
function exportDataEmail(){
	...
	//Services
	var tableDiv1 = '<table border="1"> <tr> <th>Corporate Supplier Name</th> <th>Supplier Address</th> <th>Supplier Tin</th> <th>Type of transaction</th> <th>Amount (Excluding VAT on invoice NGN)</th> <th>WHT Deducted (NGN)</th></tr>';
	...
	//Goods
	var tableDiv2 = '<table border="1"> <tr> <th>Corporate Supplier Name</th> <th>Supplier Address</th> <th>Supplier Tin</th> <th>Type of transaction</th> <th>Amount (Excluding VAT on invoice NGN)</th> <th>WHT Deducted (NGN)</th></tr>';
