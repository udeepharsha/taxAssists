...
<div id="content-wrapper">
	...
	<div class="container">
		<form id="submit_wht" name="submit_wht" method="POST">
			...
			<div class="twelve columns" id="divLoadSection">
				<h3 class="headline">
					Only WHT deducted from corporate (Incoporated Companies) suppliers should be captured here. Such WHT to be remitted to firs only.
				</h3>
