     ...
     <div id="parallex-inner" class="parallex">
          <div class="container">
               <div class="eight columns"  data-animated="fadeInUp">
                    ...
                    <br/>
                    <p>
                    	Every business organisation (or taxpayer) is mandatorily required, within 6 months of commencement of business, to compute, deduct and remit his or her employees' taxes from their salaries and their other known sources of income. The computed taxes should be remitted, with the necessary schedules before the 10th of each year following the year of salary payments. The reporting schedule from this page is the statutory P.A.Y.E remittance schedule which you can use in making your yearly P.A.Y.E remittances. Individual reports from the spool reports page appear in typical payslip formats for distribution to your employees on a yearly basis. For other personalized questions and one on one consultations on PAYE or your taxes in general, please use the feedback page and we will respond very quickly.	
                    </p>
               </div>
               <div class="eight columns">
                    <nav id="breadcrumbs">
		...
		<form id="form_name" name="form_name" method="POST" action="#" onsubmit="return false;">
			...
			<div class="twelve columns" id="divLoadSection">
				...
				<div class="twelve columns">
		     		<h3 class="headline">Please complete fields with yearly values only</h3>
		     	</div>
				...
				<div class="sixteen columns">
					<div class="rowData0">
						<div id="serviceRow1Sec">
							...
							<div class="rowTD0">
								<button class="btn" onclick="addYearValues()">Add</button>
							</div>
						</div>
					</div>
					...
					<div class="sixteen columns">
						<div class="rowHead">
							...
							<div class="rowHData">Total employment income for the year (Excluding receipted reimbursable expenses & relocation allowance) (NGN)</div>
						...
						<div class="rowData" id="rowDataYearlyValues">
...
<div id="footer-bottom">
	<!-- Container -->
 	<div class="container">
    	<div class="eight columns">
    		© Copyright 2016 <a href="index.html">Vi-M Professional Solutions</a>. All Rights Reserved.
    	</div>
      	<div class="eight columns">
